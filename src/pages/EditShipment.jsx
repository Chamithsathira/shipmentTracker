...
export default function EditShipment() {
    ...
    const updateShipment = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:5000/api/admin/shipments/${trackingId}`, {
                status,
                estimatedDelivery
            }, { headers: { Authorization: `Bearer ${token}` } });
        ...
        <div className="container mt-5">
            ...
            <form onSubmit={updateShipment}>
                ...
                <div className="mb-3">
                    ...
                    <input type="date" className="form-control" value={estimatedDelivery} onChange={(e) => setEstimatedDelivery(e.target.value)} required />
                </div>
